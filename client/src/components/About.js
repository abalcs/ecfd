...
const About = () => {
  ...
  return (
    <>
        ...
        <Container className='text-dark d-flex flex-wrap justify-content-evenly mt-4 about' >
            
            <Card border='danger' style={{ width: '30rem' }} className='shadow-lg mb-5 bg-body rounded about'>
                <Card.Img className='p-3' variant="top" src={EC} />
                <Card.Header className='bg-dark text-light text-center'>HISTORY</Card.Header>
                <Card.Text className='p-3 fs-4'>
                    <LoremIpsum
        ...
        <Container className='d-flex flex-wrap justify-content-center align-items-center volunteers'>
            <Card className='ms-5 me-5 mt-3 mb-5 shadow-lg officer' border="dark" style={{ width: '20rem' }}>
            ...
            <br />
            <Card className='ms-5 me-5 mt-auto mb-5 shadow-lg officer' border="dark" style={{ width: '20rem' }}>
